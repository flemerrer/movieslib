...
VALUES ('abaille@campus-eni.fr', 'BAILLE', 'Anne-Lise',
        '{bcrypt}$1a$00$KaSHgvH9p/cUnsOVPzYvzunWDAIv57whrOxmui0S.0AjzbP4RX6yO', true);
/*Mot de Passe = annelise*/
INSERT INTO REGISTERED_USERS (email, last_name, first_name, password)
VALUES ('jtrillard@campus-eni.fr', 'TRILLARD', 'Julien',
        '{bcrypt}$1a$00$VwQ6gMUPLeQnFC5vCsOoTevzdPe.JPu0L/6cwPGdJ5TjSpipGwY.y');
/*Mot de Passe = julien*/
INSERT INTO REGISTERED_USERS (email, last_name, first_name, password)
VALUES ('fdelaschesnais@campus-eni.fr', 'DELACHESNAIS', 'Frédéric',
        '{bcrypt}$1a$00$GhRo7SeZhL53e6E6/DQ2Le4mgkAjuesQCjQptJFh0oQLjwdeH9ZWG');
/*Mot de Passe = frederic*/
INSERT INTO REGISTERED_USERS (email, last_name, first_name, password, is_admin)
VALUES ('pmontembault@campus-eni.fr', 'MONTEMBAULT', 'Philippe',
        '{bcrypt}$1a$00$0g2xzuioWFxQLVdmc7LRKOb.sVxyH/uQQjdNg.CPX6tg2cYRK2VTe', false);
/*Mot de Passe = philippe*/
INSERT INTO REGISTERED_USERS (email, last_name, first_name, password)
VALUES ('hbernard@campus-eni.fr', 'BERNARD', 'Hervé',
        '{bcrypt}$1a$00$oYzLsRNezWP.ruY72rkYAuUH03nuNv245V2z2O3pRkuA.GwaXNGke');
/*Mot de Passe = herve*/
INSERT INTO REGISTERED_USERS (email, last_name, first_name, password)
VALUES ('tgroussard@campus-eni.fr', 'GROUSSARD', 'Thierry',
        '{bcrypt}$1a$00$ca.IC7NI1Km2kRRUoZ9EeORDJMPPe0iyyYShQ0IqPswr4YXDLqwey');
...
INSERT INTO MOVIES (title, release_date, duration, synopsis, director_id, genre_id)
VALUES ('Jurassic Park', 1993, 130,
        ...
        0, 1);
INSERT INTO MOVIES (title, release_date, duration, synopsis, director_id, genre_id)
VALUES ('The Fly', 1976, 94,
        'Il s''agit de l''adaptation cinématographique de la nouvelle éponyme de l''auteur George Langelaan.', 1, 1);
INSERT INTO MOVIES (title, release_date, duration, synopsis, director_id, genre_id)
VALUES ('The BFG', 2006, 60, 'Le Bon Gros Géant est un géant bien différent des autres habitants du Pays des Géants.',
        3, 4);
INSERT INTO MOVIES (title, release_date, duration, synopsis, director_id, genre_id)
VALUES ('Bienvenue chez les Ch''tis', 2008, 90,
        'Philippe Abrams marié à Julie (dépressive) essaie d''être mutée dans le Sud. Il se retrouve à Bergues dans le Nord.',
        2, 4);
INSERT INTO MOVIES (title, release_date, duration, synopsis, director_id, genre_id)
VALUES ('Le Pacte des Loups', 2001, 121, '', 9, 7);
